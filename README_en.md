...
JecnaAPI supports Kotlin Multiplatform for these targets: `jvm`, `android`, `wasmJs`, `js`, `linuxX64`, `iosX64`, `iosArm64`, `iosSimulatorArm64`.
...
```groovy
dependencies {
    implementation 'io.github.tomhula:jecnaapi:10.1.0'
    /* Only if you want to use it from Java, you must also add the following. */
    implementation 'io.github.tomhula:jecnaapi-java:10.1.0'
}
```
